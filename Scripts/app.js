    ...
    function readData() {
        ...
        if ((xhrParagraphDataFile.readyState === 4) && (xhrParagraphDataFile.status === 200)) {
            ...
            paragraphs.forEach(function (paragraph) {
                paragraphsContainer[counter]=paragraph.fileName;
...
*/
        ...
        for (var index = 0; index < paragraphElements.length; index++) {
            if (paragraphElements[index]) {
               // paragraphElements[index].innerHTML = paragraphsContainer[index,1];
